...
{{xtabulate4 im:LocalCoordinateTransformation im.xsd}}
...
{{xtabulate im:SourceCRS im.xsd}}

where

{{xtabulate im:Ellipsoid im.xsd}}

{{xtabulate im:PrimeMeridian im.xsd}}
...
{{xtabulate im:TransverseMercator im.xsd}}
...
{{xtabulate im:Helmert2D im.xsd}}

{{xtabulate im:FittedPlane im.xsd}}
